# Generated by Django 5.2.3 on 2025-09-03 13:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nome_certificado",
                    models.CharField(max_length=200, verbose_name="Certificado"),
                ),
                (
                    "orgao_competente",
                    models.CharField(max_length=200, verbose_name="Órgão Competente"),
                ),
                (
                    "link_orgao",
                    models.URLField(
                        blank=True, null=True, verbose_name="Link do Órgão"
                    ),
                ),
